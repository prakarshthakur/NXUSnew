 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qa(t,e,n){return`firebase:${t}:${e}:${n}`}class Ri{constructor(e,n,r){this.persistence=e,this.auth=n,this.userKey=r;const{config:i,name:s}=this.auth;this.fullUserKey=qa(this.userKey,i.apiKey,s),this.fullPersistenceKey=qa("persistence",i.apiKey,s),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?pn._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,r="authUser"){if(!n.length)return new Ri(mn(Vg),e,r);const i=(await Promise.all(n.map(async d=>{if(await d._isAvailable())return d}))).filter(d=>d);let s=i[0]||mn(Vg);const o=qa(r,e.config.apiKey,e.name);let l=null;for(const d of n)try{const p=await d._get(o);if(p){const m=pn._fromJSON(e,p);d!==s&&(l=m),s=d;break}}catch{}const u=i.filter(d=>d._shouldAllowMigration);return!s._shouldAllowMigration||!u.length?new Ri(s,e,r):(s=u[0],l&&await s._set(o,l.toJSON()),await Promise.all(n.map(async d=>{if(d!==s)try{await d._remove(o)}catch{}})),new Ri(s,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sk(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function ok(t){const e=Ps(bs(t)).link,n=e?Ps(bs(e)).deep_link_id:null,r=Ps(bs(t)).deep_link_id;return(r?Ps(bs(r)).link:null)||r||n||e||t}class ff{constructor(e){var n,r,i,s,o,l;const u=Ps(bs(e)),d=(n=u.apiKey)!==null&&n!==void 0?n:null,p=(r=u.oobCode)!==null&&r!==void 0?r:null,m=sk((i=u.mode)!==null&&i!==void 0?i:null);K(d&&p&&m,"argument-error"),this.apiKey=d,this.operation=m,this.code=p,this.continueUrl=(s=u.continueUrl)!==null&&s!==void 0?s:null,this.languageCode=(o=u.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(l=u.tenantId)!==null&&l!==void 0?l:null}static parseLink(e){const n=ok(e);try{return new ff(n)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function RP(t){t=Ct(t,ot);const e=Ct(t.firestore,hr);return uP(Tu(e),t._key).then(n=>EE(e,t,n))}class tp extends kP{constructor(e){super(),this.firestore=e}convertBytes(e){return new Hi(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new ot(this.firestore,null,n)}}function PP(t){t=Ct(t,ei);const e=Ct(t.firestore,hr),n=Tu(e),r=new tp(e);return mE(t._query),cP(n,t._query).then(i=>new vE(e,r,t,i))}function My(t,e,n,...r){t=Ct(t,ot);const i=Ct(t.firestore,hr),s=Qf(i);let o;return o=typeof(e=De(e))=="string"||e instanceof Iu?wP(s,"updateDoc",t._key,e,n,r):_P(s,"updateDoc",t._key,e),np(i,[o.toMutation(t._key,zt.exists(!0))])}function bP(t){return np(Ct(t.firestore,hr),[new kf(t._key,zt.none())])}function _E(t,e){const n=Ct(t.firestore,hr),r=Ys(t),i=AP(t.converter,e);return np(n,[vP(Qf(t.firestore),"addDoc",r._key,i,t.converter!==null,{}).toMutation(r._key,zt.exists(!1))]).then(()=>r)}function wE(t,...e){var n,r,i;t=De(t);let s={includeMetadataChanges:!1,source:"default"},o=0;typeof e[o]!="object"||Oy(e[o])||(s=e[o],o++);const l={includeMetadataChanges:s.includeMetadataChanges,source:s.source};if(Oy(e[o])){const m=e[o];e[o]=(n=m.next)===null||n===void 0?void 0:n.bind(m),e[o+1]=(r=m.error)===null||r===void 0?void 0:r.bind(m),e[o+2]=(i=m.complete)===null||i===void 0?void 0:i.bind(m)}let u,d,p;if(t instanceof ot)d=Ct(t.firestore,hr),p=hu(t._key.path),u={next:m=>{e[o]&&e[o](EE(d,t,m))},error:e[o+1],complete:e[o+2]};else{const m=Ct(t,ei);d=Ct(m.firestore,hr),p=m._query;const g=new tp(d);u={next:E=>{e[o]&&e[o](new vE(d,g,m,E))},error:e[o+1],complete:e[o+2]},mE(t._query)}return function(g,E,A,P){const N=new Wf(P),T=new Bf(E,N,A);return g.asyncQueue.enqueueAndForget(async()=>jf(await zl(g),T)),()=>{N.Za(),g.asyncQueue.enqueueAndForget(async()=>Uf(await zl(g),T))}}(Tu(d),p,l,u)}function np(t,e){return function(r,i){const s=new vn;return r.asyncQueue.enqueueAndForget(async()=>JR(await lP(r),i,s)),s.promise}(Tu(t),e)}function EE(t,e,n){const r=n.docs.get(e._key),i=new tp(t);return new yE(t,i,e._key,r,new Vs(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){(function(i){es=i})(Ji),ji(new Wr("firestore",(r,{instanceIdentifier:i,options:s})=>{const o=r.getProvider("app").getImmediate(),l=new hr(new bA(r.getProvider("auth-internal")),new VA(r.getProvider("app-check-internal")),function(d,p){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new W(M.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new xo(d.options.projectId,p)}(o,i),o);return s=Object.assign({useFetchStreams:n},s),l._setSettings(s),l},"PUBLIC").setMultipleInstances(!0)),ir(Xg,"4.7.3",e),ir(Xg,"4.7.3","esm2017")})();const NP={apiKey:"AIzaSyC7UHaQ9ndrf58hQVr8LRpPGkQiYwUdUcU",authDomain:"nxusdxb.firebaseapp.com",projectId:"nxusdxb",storageBucket:"nxusdxb.firebasestorage.app",messagingSenderId:"518385929367",appId:"1:518385929367:web:c3bf8f1937b9e23443add2"},xE=y_(NP),fr=SA(xE),Bn=fP(xE),TE=new cn,IE=L.createContext({user:null,loading:!0});function DP({children:t}){const[e,n]=L.useState(null),[r,i]=L.useState(!0);return L.useEffect(()=>mk(fr,o=>{n(o),i(!1)}),[]),f.jsx(IE.Provider,{value:{user:e,loading:r},children:t})}function ti(){return L.useContext(IE)}const OP=[{key:"discord",label:"discord",href:"https://discord.gg/JDxPnzys",icon:f.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:f.jsx("path",{d:"M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057c.002.022.015.043.032.054a19.9 19.9 0 0 0 5.993 3.03.077.077 0 0 0 .084-.028 14.09 14.09 0 0 0 1.226-1.994.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.892.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z"})})},{key:"instagram",label:"instagram",href:"https://www.instagram.com/nxusdxb/",icon:f.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:f.jsx("path",{d:"M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"})})}],VP="https://api.freewaitlists.com/waitlists/cmnrq1m75087001pnr40o6xtf",LP={discord:{eyebrow:"Community",title:"Join Discord",body:"Meet the first people planning the first drops."},instagram:{eyebrow:"Updates",title:"Follow Instagram",body:"Watch the build, the launch, and the Dubai rollout."}},MP=[{icon:"🏙️",label:"Dubai First"},{icon:"⚡",label:"Real-Time Drops"},{icon:"🎯",label:"No Scroll, Just Show Up"}];function FP(){const t=vr(),{user:e}=ti(),[n,r]=L.useState(0),[i,s]=L.useState(""),[o,l]=L.useState(""),[u,d]=L.useState(!1),[p,m]=L.useState({tone:"idle",message:""}),[g,E]=L.useState(!1),[A,P]=L.useState(""),[N,T]=L.useState(""),_=15;L.useEffect(()=>{if(n===0||n>=_)return;const v=window.setTimeout(()=>{r(0)},2500);return()=>window.clearTimeout(v)},[_,n]);const k=()=>{r(v=>{const w=v+1;return w>=_?(t("/login"),0):w})},O=async v=>{v.preventDefault();const w=o.trim(),S=i.trim();if(!w){m({tone:"error",message:"Drop your email so we know where to send the invite."});return}d(!0),m({tone:"idle",message:""});const C={email:w,meta:{source:"nxus-coming-soon",...S?{name:S}:{}}};try{const R=await fetch(VP,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(C)}),I=await R.json().catch(()=>null);if(!R.ok)throw new Error((I==null?void 0:I.message)||"Unable to save your spot right now.");m({tone:"success",message:"You're on the list. We'll reach out when NXUS opens up."}),s(""),l("")}catch(R){m({tone:"error",message:R.message||"Something went wrong. Please try again in a minute."})}finally{d(!1)}},V=()=>{if(e){t("/home");return}P(""),T(""),E(!0)},F=()=>{E(!1),P(""),T("")},x=v=>{if(v.preventDefault(),A.trim()==="ZOOWEEMAMA"){window.sessionStorage.setItem("earlyAccess","true"),t("/signup");return}T("Invalid access code")};return f.jsxs("main",{className:"nxus-shell",children:[f.jsx("style",{children:`
      ...
      `}),f.jsx("div",{className:"nxus-divider","aria-hidden":"true"}),f.jsxs("div",{className:"nxus-layout",children:[f.jsxs("section",{className:"nxus-left","aria-labelledby":"nxus-coming-soon-title",children:[f.jsxs("div",{className:"nxus-hero",children:[f.jsx("button",{type:"button",onClick:k,"aria-label":"NXUS logo",className:"nxus-logo-button",children:f.jsx("img",{src:"/assets/nxus_logo_icon.svg",alt:"NXUS bowtie logo"})}),f.jsx("div",{className:"nxus-kicker",children:"Coming Soon"}),f.jsxs("h1",{className:"nxus-title",id:"nxus-coming-soon-title",children:[f.jsx("span",{children:"Kill your"}),f.jsx("span",{children:"Boredom"})]}),f.jsx("p",{className:"nxus-subhead",children:"Find your people. Show up. Repeat."}),f.jsx("div",{className:"nxus-stat-row","aria-label":"Launch details",children:MP.map(v=>f.jsxs("div",{className:"nxus-stat",children:[f.jsx("span",{"aria-hidden":"true",children:v.icon}),f.jsx("span",{children:v.label})]},v.label))})]}),f.jsx("div",{className:"nxus-footer-mark",children:"NXUS, from us, to you"})]}),f.jsx("section",{className:"nxus-right","aria-label":"Early access waitlist",children:f.jsxs("div",{className:"nxus-action",children:[f.jsxs("header",{className:"nxus-action-header",children:[f.jsx("div",{className:"nxus-eyebrow",children:"Early Access"}),f.jsx("h2",{className:"nxus-action-title",children:"Claim Your Spot"})]}),f.jsxs("form",{className:"nxus-form",onSubmit:O,children:[f.jsxs("label",{className:"nxus-field",children:[f.jsx("span",{className:"nxus-field-label",children:"Name"}),f.jsx("span",{className:"nxus-input-wrap",children:f.jsx("input",{className:"nxus-input",type:"text",value:i,onChange:v=>s(v.target.value),placeholder:"Your name",autoComplete:"name"})})]}),f.jsxs("label",{className:"nxus-field",children:[f.jsx("span",{className:"nxus-field-label",children:"Email"}),f.jsx("span",{className:"nxus-input-wrap",children:f.jsx("input",{className:"nxus-input",type:"email",value:o,onChange:v=>l(v.target.value),placeholder:"you@example.com",autoComplete:"email",required:!0})})]}),f.jsx("button",{className:"nxus-cta",type:"submit",disabled:u,children:u?"Saving Your Spot...":"Join The Waitlist →"}),f.jsx("p",{className:"nxus-form-note","data-tone":p.tone,children:p.message||"140+ people already in. Dubai opens first."})]}),f.jsxs("button",{className:"nxus-access-trigger",type:"button",onClick:V,children:[f.jsx("span",{className:"nxus-access-lock","aria-hidden":"true",children:"🔒"}),"Early Access"]}),f.jsx("div",{className:"nxus-rule","aria-hidden":"true"}),f.jsx("div",{className:"nxus-socials","aria-label":"NXUS social links",children:OP.map(v=>{const w=LP[v.key];return f.jsxs("a",{className:"nxus-social-card",href:v.href,target:"_blank",rel:"noopener noreferrer",children:[f.jsx("span",{className:"nxus-social-icon","aria-hidden":"true",children:v.icon}),f.jsxs("span",{className:"nxus-social-text",children:[f.jsx("span",{className:"nxus-social-eyebrow",children:w.eyebrow}),f.jsx("span",{className:"nxus-social-title",children:w.title}),f.jsx("span",{className:"nxus-social-body",children:w.body})]}),f.jsx("span",{className:"nxus-social-arrow","aria-hidden":"true",children:"→"})]},v.key)})}),f.jsxs("footer",{className:"nxus-mobile-footer",children:[f.jsx("span",{children:"More friends. More fun."}),f.jsx("span",{children:"nxus.fun"})]})]})})]}),g?f.jsx("div",{className:"nxus-modal-backdrop",role:"presentation",onMouseDown:v=>{v.target===v.currentTarget&&F()},children:f.jsxs("section",{className:"nxus-modal",role:"dialog","aria-modal":"true","aria-labelledby":"nxus-access-title",children:[f.jsxs("div",{className:"nxus-modal-header",children:[f.jsxs("div",{children:[f.jsx("div",{className:"nxus-eyebrow",children:"Locked Drop"}),f.jsx("h2",{className:"nxus-modal-title",id:"nxus-access-title",children:"Enter Access Code"})]}),f.jsx("button",{className:"nxus-modal-close",type:"button",onClick:F,"aria-label":"Close access code modal",children:"x"})]}),f.jsxs("form",{className:"nxus-form",onSubmit:x,children:[f.jsxs("label",{className:"nxus-field",children:[f.jsx("span",{className:"nxus-field-label",children:"Access Code"}),f.jsx("span",{className:"nxus-input-wrap",children:f.jsx("input",{className:"nxus-input",type:"password",value:A,onChange:v=>{P(v.target.value),T("")},placeholder:"Enter code",autoComplete:"off",autoFocus:!0})})]}),f.jsx("p",{className:"nxus-access-error","aria-live":"polite",children:N}),f.jsxs("button",{className:"nxus-cta",type:"submit",children:["Unlock Signup ","→"]})]})]})}):null]})}function jP(){const t=vr(),[e,n]=L.useState(""),[r,i]=L.useState(""),[s,o]=L.useState(""),[l,u]=L.useState(""),[d,p]=L.useState(!1),m=async E=>{if(E.preventDefault(),u(""),r.length<6){u("Password must be at least 6 characters.");return}if(r!==s){u("Passwords don’t match.");return}p(!0);try{await dk(fr,e.trim(),r);const A=window.sessionStorage.getItem("redirectAfterLogin")||"/home";window.sessionStorage.removeItem("redirectAfterLogin"),t(A)}catch(A){u(Fy(A.code))}finally{p(!1)}},g=async()=>{u(""),p(!0);try{await Z_(fr,TE);const E=window.sessionStorage.getItem("redirectAfterLogin")||"/home";window.sessionStorage.removeItem("redirectAfterLogin"),t(E)}catch(E){E.code!=="auth/popup-closed-by-user"&&u(Fy(E.code))}finally{p(!1)}};return f.jsxs("main",{className:"nxus-auth-shell",children:[f.jsx("style",{children:`
        .nxus-auth-shell {
          min-height: 100vh;
          display: grid;
          place-items: center;
  ...
  `,document.head.appendChild(t)}function tb(){return f.jsxs("footer",{className:"nxus-site-footer",children:[f.jsx("style",{children:`
        .nxus-site-footer {
          width: 100%;
      ...
      `}),f.jsx(Il,{to:"/privacy",children:"Privacy Policy"}),f.jsx("span",{className:"nxus-footer-dot","aria-hidden":"true",children:"·"}),f.jsx(Il,{to:"/terms",children:"Terms of Service"}),f.jsx("span",{className:"nxus-footer-dot","aria-hidden":"true",children:"·"}),f.jsx("a",{href:"mailto:prakarsh@nxus.fun",children:"Support"})]})}function nb(){const{eventId:t}=u2(),e=vr(),{user:n}=ti(),[r,i]=L.useState(null),[s,o]=L.useState(!0),[l,u]=L.useState(!1);L.useEffect(()=>{(async()=>{try{const g=Ys(Bn,"events",t),E=await RP(g);E.exists()?i({id:E.id,...E.data()}):u(!0)}catch(g){console.error("Error fetching event:",g),u(!0)}finally{o(!1)}})()},[t]);const d=()=>{e(n?"/home":"/")},p=async()=>{await mf(fr),e("/login")};return s?f.jsx("div",{className:"nxus-detail-shell",children:f.jsx("div",{className:"nxus-loading",children:"Loading event..."})}):l||!r?f.jsx("div",{className:"nxus-detail-shell",children:f.jsxs("div",{className:"nxus-error",children:[f.jsx("p",{children:"Event not found."}),f.jsx("button",{onClick:d,className:"nxus-back-btn",children:"← Back"})]})}):f.jsxs("main",{className:"nxus-detail-shell",children:[f.jsx("style",{children:`
        .nxus-detail-shell {
          min-height: 100vh;
          background: #000000;
          color: #F0EDE8;
      ...
      `}),f.jsxs("nav",{className:"nxus-home-nav",children:[f.jsxs("div",{className:"nxus-home-nav-left",style:{cursor:"pointer"},onClick:()=>e("/home"),children:[f.jsx("img",{className:"nxus-home-nav-logo",src:"/assets/nxus_logo_icon.svg",alt:"NXUS"}),f.jsx("span",{className:"nxus-home-nav-brand",children:"NXUS"})]}),n&&f.jsxs("div",{className:"nxus-home-nav-right",children:[f.jsx("span",{className:"nxus-home-nav-email",children:n.email}),f.jsx("button",{className:"nxus-home-nav-signout",onClick:p,children:"Sign Out"})]})]}),f.jsxs("div",{className:"nxus-detail-content",style:{marginTop:"2rem"},children:[f.jsx("button",{className:"nxus-back-btn",onClick:d,children:"← Back"}),f.jsx("h1",{className:"nxus-event-title-detail",children:r.title}),f.jsxs("div",{className:"nxus-event-meta-detail",children:[f.jsxs("span",{className:"nxus-meta-item",children:[f.jsx("span",{className:"nxus-meta-icon",children:"📅"}),r.date]}),f.jsxs("span",{className:"nxus-meta-item",children:[f.jsx("span",{className:"nxus-meta-icon",children:"📍"}),r.location]})]}),f.jsx("div",{className:"nxus-event-desc",children:r.fullDescription||r.shortDescription}),f.jsx("a",{href:r.formLink,target:"_blank",rel:"noopener noreferrer",className:"nxus-join-btn",children:"Join Now →"})]})]})}function rb(){return f.jsxs("main",{className:"nxus-legal-shell",children:[f.jsx("style",{children:`
        .nxus-legal-shell {
          min-height: 100vh;
          background: #0A0A0A;
          color: #F0EDE8;
